...
export function UsbFtdi() {
  return <>
    <connector name="J1" {...at("J1")} manufacturerPartNumber="B2B-PH-K-S(LF)(SN)" supplierPartNumbers={{jlcpcb: ["C131337"]}} footprint="pinrow2_p2mm" pinLabels={{pin1:"VIN",pin2:"GND"}} />
    ...
    <chip name="U11" {...at("U11")} manufacturerPartNumber="93LC46BT-I/SN" supplierPartNumbers={{jlcpcb: ["C16253"]}} footprint="soic8_w6.95mm_p1.27mm_pl1.55mm_pw0.6mm" pinLabels={{pin1:"CS",pin2:"CLK",pin3:"DI",pin4:"DO",pin5:"GND",pin6:"NC6",pin7:"NC7",pin8:"VCC"}} pinAttributes={{VCC:{requiresPower:true},GND:{requiresGround:true}}} />
    <chip name="X2" {...at("X2")} manufacturerPartNumber="ABM8-12.000MHZ-B2-T" supplierPartNumbers={{jlcpcb: ["C596894"]}} footprint="crystal4_px2.3mm_py1.75mm_pw1.3mm_ph1.05mm" pinLabels={{pin1:"X1",pin2:"GND1",pin3:"X2",pin4:"GND2"}} />
    <chip name="FB1" {...at("FB1")} manufacturerPartNumber="BLM18AG601SN1D" supplierPartNumbers={{jlcpcb: ["C19330"]}} footprint="0603" pinLabels={{pin1:"IN",pin2:"OUT"}} />
